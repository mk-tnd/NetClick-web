    ...
    <div>
      ...
      >
        ...
        <div className=" flex " style={{ width: "100%", height: "93.5vh" }}>
          ...
          >
            <div
              className="bg-black opacity-90 flex flex-col items-center"
              style={{ width: "500px", height: "500px" }}
            >
              <div className="self-start">
                <h1 className="text-gray-200 text-4xl mt-10 ml-5 sm:ml-10  font-medium">
                  Sign In
                </h1>
              </div>
              <div className="flex flex-col mt-11">
                ...
                <div className="mt-7">
                  <div
                    ...
                    className="absolute"
                    style={{ marginLeft: "270px", marginTop: "1px" }}
                  >
                ...
                <div className="self-center">
                  <button
                    onClick={login}
                    className="text-white bg-red-500 mt-10  pt-2 pb-2 pl-5 pr-5 text-center"
                    style={{ width: "200px" }}
                  >
                    Sign in
                  </button>
                ...
                <div className="text-center mt-4">
                  <span className="text-gray-400">New to Netclick ?</span>{" "}
